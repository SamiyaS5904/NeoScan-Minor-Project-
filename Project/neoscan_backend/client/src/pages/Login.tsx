  ...
  return (
    <div className="min-h-screen flex-center px-4 pt-20">
      ...
      >
        ...
        <p className="text-center text-muted-foreground mb-8">Enter your credentials to access your dashboard.</p>
        ...
        <p className="text-center mt-8 text-muted-foreground font-medium">
          Don't have an account? <Link href="/register" className="text-[hsl(var(--primary))] hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
