  ...
  return (
    <div className="min-h-screen flex-center px-4 pt-20 pb-10">
      ...
      >
        ...
        <h2 className="text-3xl font-display font-bold text-center text-foreground mb-2">Create Account</h2>
        <p className="text-center text-muted-foreground mb-8">Start tracking with NeoScan today.</p>
        ...
        <p className="text-center mt-6 text-muted-foreground font-medium">
          Already have an account? <Link href="/login" className="text-[hsl(var(--primary))] hover:underline">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
